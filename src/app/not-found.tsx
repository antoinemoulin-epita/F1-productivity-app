                ...
                <div className="flex w-full max-w-3xl flex-col gap-8 md:gap-12">
                    <div className="flex flex-col gap-4 md:gap-6">
                        <div className="flex flex-col gap-3">
                            <span className="text-md font-semibold text-brand-secondary">Erreur 404</span>
                        ...
                        <p className="text-lg text-tertiary md:text-xl">Désolé, la page que vous recherchez n&apos;existe pas ou a été déplacée.</p>
                    </div>
                    ...
                    <div className="flex flex-col-reverse gap-3 sm:flex-row">
                        ...
                        <Button size="xl" onClick={() => router.push("/landing")}>
                            Aller à l&apos;accueil
                        </Button>
                    </div>
                </div>
