                    ...
                    <div className="space-y-8">
                        ...
                        <div className="overflow-hidden rounded-xl border border-white/10 bg-[#1a1a1a] p-6 md:p-8 dark:bg-[#1a1a1a]">
                            ...
                            <div className="relative min-h-80 overflow-x-auto rounded-lg bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 p-8">
                                ...
                                <div className="relative h-24 space-y-6">
                                    {/* Car 1 - Leader */}
                                    <div className="absolute transition-all duration-500" style={{ left: "85%", top: "0" }}>
                                        <div className="flex flex-col items-center gap-1">
                                            <div className="m-auto flex h-14 w-28 items-center justify-center rounded-2xl bg-red-300/20">
                                                <img src={"/car.png"} className="w-40" />
                                            </div>
                                            <div className="flex w-28 justify-between">
                                                <span className="text-xs font-bold text-white">Antoine</span>
                                                <span className="text-xs text-yellow-400">1° • 85%</span>
                                            </div>
                                        </div>
                                    </div>

                                    {/* Car 2 */}
                                    <div className="absolute transition-all duration-500" style={{ left: "72%", top: "6rem" }}>
                                        <div className="flex flex-col items-center gap-1">
                                            <div className="m-auto flex h-14 w-28 items-center justify-center rounded-2xl bg-blue-300/20">
                                                <img src={"/car.png"} className="w-40" />
                                            </div>
                                            <div className="flex w-28 justify-between">
                                                <span className="text-xs font-bold text-white">Nathan</span>
                                                <span className="text-xs text-gray-400">2° • 72%</span>
                                            </div>
                                        </div>
                                    </div>

                                    {/* Car 3 */}
                                    <div className="absolute transition-all duration-500" style={{ left: "58%", top: "12rem" }}>
                                        <div className="flex flex-col items-center gap-1">
                                            <div className="m-auto flex h-14 w-28 items-center justify-center rounded-2xl bg-green-300/20">
                                                <img src={"/car.png"} className="w-40" />
                                            </div>
                                            <div className="flex gap-4">
                                                <span className="text-xs font-bold text-white">Benjamin</span>
                                                <span className="text-xs text-gray-400">3° • 63%</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
