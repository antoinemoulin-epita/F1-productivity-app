...
export const DeveloperIndex = ({ pages, categories }: DeveloperIndexProps) => {
    return (
        <div className="relative overflow-hidden bg-primary">
            ...
            <section className="relative overflow-hidden py-16 md:py-24">
                <div className="mx-auto max-w-container px-4 md:px-8">
                                    ...
                                    <div className="grid w-full gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                        {categoryPages.map((page) => (
                                            <a
                                                key={page.path}
                                                href={page.path}
                                                className="group flex flex-col justify-between rounded-xl border border-primary/10 bg-secondary p-6 transition duration-200 ease-in-out hover:border-primary/20 hover:shadow-md"
                                            >
                                                <div>
                    ...
                    {/* Info section */}
                    <div className="mt-16 rounded-xl border border-primary/10 bg-secondary p-8 md:p-12">
